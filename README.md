...
레포지토리 설계가 잘못되었다.
<br>🚀해결 방법🚀<br>
JavaScript에서 console 출력을 통해 어느 부분에서 오류가 발생하는지 확인하고, Controller부터 Service, Repository까지 거슬러 올라가면서
Slf4j 어노테이션으로 출력을 통해 오류를 확인한 후 레포지토리 설계가 잘못된 것을 확인하고 그 부분을 수정했다.
